...
const ContactPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 w-full pt-16 sm:pt-24 pb-16 sm:pb-24" id="Contact">
      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
        ...
        <div className="w-full lg:w-1/2" data-aos="fade-left">
          <div className="bg-[#2c2620] border border-white/5 rounded-xl p-6 sm:p-8 shadow-2xl transition-all duration-500 hover:border-accent/20">
            <div className="flex justify-between items-start mb-8">
              <div>
                <h3 className="text-xl font-black text-white uppercase tracking-tight mb-2">Message Me</h3>
                <p className="text-grayText text-sm font-medium">I'm always open to new opportunities.</p>
              </div>
