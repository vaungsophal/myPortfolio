...
const SOCIAL_LINKS = [
  ...
  { icon: Linkedin, link: "https://www.linkedin.com/in/sophal-vaung/" },
  { icon: Instagram, link: "https://www.instagram.com/pol_g0o" }
];
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="px-[5%] sm:px-[10%] lg:px-[10%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20 py-20 lg:py-0">
            ...
            <div className="w-full py-[10%] sm:py-0 lg:w-1/2 h-auto lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2 mt-8 lg:mt-0"
              ...
              <div className="relative w-full opacity-90">
                ...
                <div className={`relative z-10 w-full opacity-90 transform transition-all duration-500 ${isHovering ? "scale-105" : "scale-100"
                  }`}>
