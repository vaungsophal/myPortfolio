      ...
      <div className="relative">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
            <button
              onClick={() => navigate(-1)}
              className="group inline-flex items-center space-x-1.5 md:space-x-2 px-2 md:px-4 py-1.5 md:py-2 bg-white/5 backdrop-blur-xl rounded-md text-white/90 hover:bg-white/10 transition-all duration-300 border border-white/10 hover:border-accent/20 text-sm md:text-base font-medium"
            >
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                <a
                  ...
                  className="group relative inline-flex items-center space-x-1.5 md:space-x-2 px-3 md:px-6 py-2 md:py-3 bg-accent text-background rounded-md transition-all duration-300 border border-accent hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:scale-105 overflow-hidden text-sm md:text-base font-black uppercase tracking-wider"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group relative inline-flex items-center space-x-1.5 md:space-x-2 px-3 md:px-6 py-2 md:py-3 bg-white/5 text-white/90 rounded-md transition-all duration-300 border border-white/10 hover:bg-white/10 hover:border-white/20 overflow-hidden text-sm md:text-base font-bold uppercase tracking-wider"
